package com.challengealura.findbook.principal;

import com.challengealura.findbook.models.Autor;
import com.challengealura.findbook.models.Datos;
import com.challengealura.findbook.models.DatosDeLibro;
import com.challengealura.findbook.models.Libro;
import com.challengealura.findbook.repository.libroRepository;
import com.challengealura.findbook.service.ConsumoAPI;
import com.challengealura.findbook.service.ConvierteDatos;
...
public Principal(autorRepository repositorioDeAutor, libroRepository repositorioDeLibros) {
    ...
    private void listaAutoresVivos(){
        ...
        autores = repositorioDeAutor.findAll();
        autores.stream()
                .filter(a -> (fechaReferencia <= a.getFechaFallecimiento())&&(fechaReferencia >=a.getFechaNacimiento()))
                .forEach(System.out::println);
    }
